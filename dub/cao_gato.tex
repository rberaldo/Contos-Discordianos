...
Mas, quando se é um cachorro, você não viaja muito. E se você é um cachorro inteligente que ouve rádio-novela, você descobre que em algumas viagens, os cachorros não voltam. Mas isso não impede de você abanar a porra do rabo toda vez que vê o dono balançar a chave do carro.

Se você é um cachorro inteligente de verdade, você não fica ouvindo rádio-novela.

Mas não tem muita coisa pra se fazer nesse ano de de 1931.
...
Alguns dizem que os animais sabem instintivamente do ciclo da natureza e simplesmente não temem a morte por que ela é algo natural. Eu sou um cachorro, e digo que se soubesse quando eu vou morrer, eu choraria feito um recém nascido.
...
Quando você sai do útero, é como a morte. Você não faz idéia de para onde está indo.
...
``Merda, o útero era tão bom\ldots Por que tenho que eu fui condenado a morar do lado de fora?''
...
Mas pra quê? Pra limpar o nome do ``livro da vida''? Pra não pagar impostos no jogo cósmico?
...
``Cães com pães''. ``Cães com pães''. ``Cães com pães''. Legal, não? Vai ver foi num trocadilho desses que surgiu o cachorro-quente.
...
E o tempo foi passando, e o tempo é uma droga que você tem que tomar mesmo sem que te receitem, e ele te deixa sucetível a qualquer merda.
...
Alguns dos cachorros eram muito idiotas para pensar, e ele gostava disso. O russo barbudo com fetiche por saliva de cachorro gostava dos cachorros que atendiam suas espectativas sem questionar nada.

Alguns cachorros eram espertos demais para pensar, e ele gostava disso. O russo barbudo com fetiche por saliva de cachorro gostava dos cachorros que atendiam suas espectativas sem questionar nada.

Ele tinha que escolhar um cachorro mediano. Ele tinha que escolher um nem-que-sim, nem-que-não.
...
Um russo barbudo com fetiche por saliva canina jamais admitira publicamente seu fetiche. Ele sempre achou que ninguém aceitaria. Jamais tentou contar pra ninguém seu fetiche.
...
Cães não tem muito nojo\ldots Vai ver é por isso os cães são os melhores amigos do homem.
...
O austríaco maníaco diz que tranca gatos em caixas com uma armadilha especialmente preparada, que tem 50\% de disparar.
...
E se o gato já estivesse morto, pra quê matar o gato?
...
Merda\ldots Queria saber se, depois da caixa ser aberta, o gato vai ficar 100\% vivo ou 100\% morto.
